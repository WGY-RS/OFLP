function descriptors = GLOH_descriptors...
    ...
    parfor i = 1:1:M
        ...
        scale = sigma_1 * ratio^(layer-1);
        descriptors(i, :) = calc_log_polar_descriptor(current_gradient, current_angle, x, y, main_angle, d, n, Path_Block, scale, sigma_1, layer, circle_count);
    end    
