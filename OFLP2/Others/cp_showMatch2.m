function [out] = cp_showMatch2(I1,I2,loc1,loc2,correctPos,tname)
%% 首先确保图像都是三通道影像
[~,~,num_1] =size(I1);
[~,~,num_2] =size(I2);
if num_1>3
...
% for i=1:size(loc1,1)
%     if loc1(i,5) == 0
%         line([loc1(i,1) loc2(i,1)+cols]',[loc1(i,2) loc2(i,2)]', 'Color', 'r','LineWidth',1.5);
%     end        
% end
% hold on
% for i=1:size(loc1,1)
%     if loc1(i,5) == 1
%         line([loc1(i,1) loc2(i,1)+cols]',[loc1(i,2) loc2(i,2)]', 'Color', 'b','LineWidth',1.5);
%     end        
% end
...
hold on
    ...
    line([loc1(:,1) loc2(:,1)+cols]',[loc1(:,2) loc2(:,2)]', 'Color', 'r','LineWidth',1.3);
