...
%     loc2(correctPos,:) = [];
hold on
    line([loc1(correctPos,1) loc2(correctPos,1)+cols]',[loc1(correctPos,2) loc2(correctPos,2)]', 'Color', 'b','LineWidth',2.5);
    plot(loc1(correctPos,1),loc1(correctPos,2),'g*');
    plot(loc2(correctPos,1)+cols,loc2(correctPos,2),'g*');

else
    line([loc1(:,1) loc2(:,1)+cols]',[loc1(:,2) loc2(:,2)]', 'Color', 'b','LineWidth',2.3);
